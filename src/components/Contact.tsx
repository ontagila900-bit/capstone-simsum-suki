    ...
    <section id="kontak" className="py-20 bg-brand-cream/35 border-t border-brand-cream-dark/50 relative scroll-mt-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-6 flex flex-col justify-between bg-white rounded-3xl p-8 border border-brand-cream shadow-md">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs sm:text-sm font-bold text-brand-charcoal leading-tight mt-0.5">
                        ...
                        <span className="text-[10px] font-mono text-primary-orange">(Biasa sold out jam 21.00!)</span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs sm:text-sm font-bold text-brand-charcoal leading-tight mt-0.5">
                        Buka Setiap Hari <br />
                        <span className="text-[10px] font-mono text-gray-400">(Senin s/d Minggu)</span>
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="border-t border-brand-cream-dark/50 pt-6 mt-8 flex flex-col gap-3">
                ...
                {socialLinks.map((item) => {
                  ...
                  return (
                    <a
                      ...
                      className="flex-1 bg-brand-cream/40 border border-brand-cream-dark hover:bg-brand-cream-dark/20 p-3.5 rounded-xl flex items-center justify-between gap-3 transition-colors cursor-pointer group"
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="text-left font-sans">
                          <p className="text-[10px] font-bold uppercase tracking-wider text-gray-400 font-mono leading-none">
                            {item.name}
                          </p>
                          <p className="text-xs font-bold text-brand-charcoal group-hover:text-primary-orange mt-0.5">
                            {item.handle}
                          </p>
                        </div>
                      </div>
                      <ExternalLink className="w-3.5 h-3.5 text-gray-450 opacity-0 group-hover:opacity-100 transition-opacity" />
                    </a>
                  );
                })}
              </div>
          ...
          <div className="lg:col-span-6 bg-brand-charcoal text-white rounded-3xl p-8 sm:p-10 border border-brand-charcoal-light flex flex-col justify-center items-center relative overflow-hidden">
