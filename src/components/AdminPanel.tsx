                              ...
                              const glossaryList = [
                                {
                                  ...
                                  desc: 'Total kustomer unik yang membuka halaman menu Suki YuSuki.',
                                  formula: 'Dihitung per kunjungan perangkat unik.',
                                  leakageExplanation: 'Kunjungan rendah berarti promosi atau penyebaran tautan menu di media sosial Anda masih kurang gencar.',
                                  action: 'Sebarkan link menu di bio Instagram, TikTok, WhatsApp Story, atau cetak QR Code di kasir & meja makan.',
                                  borderColor: 'border-l-blue-500 bg-blue-50/10'
                                },
                                {
                                  name: 'Add To Cart (Masuk Keranjang)',
                                  symbol: '🛒',
                                  category: 'visit',
                                  categoryLabel: 'Kunjungan',
                                  desc: 'Jumlah sesi di mana kustomer mulai memilih menu dan memasukannya ke dalam keranjang belanja.',
                                  formula: 'Dihitung per sesi belanja kustomer.',
                                  leakageExplanation: 'Bila kunjungan web tinggi namun penambahan keranjang rendah, berarti visual menu atau harga kurang ramah pembeli.',
                                  action: 'Tampilkan foto menu suki yang memikat, beri tag rekomendasi di rasa terfavorit, serta tawarkan paket bundling hemat.',
                                  borderColor: 'border-l-rose-500 bg-rose-50/10'
                                },
                                {
                                  name: 'Draft Invoice (Buat Nota)',
                                  symbol: '🧾',
                                  category: 'conv',
                                  categoryLabel: 'Konversi',
                                  desc: 'Kustomer yang mengisi data pengiriman (nama & meja/telepon) dan berhasil membuat lembaran draf nota.',
                                  formula: '(Total Invoice Terbuat / Sesi Keranjang) * 100%',
                                  leakageExplanation: 'Bila kustomer berhenti di tahap ini, pertanda formulir terlalu panjang, rumit, atau kustomer ragu mengisi informasi.',
                                  action: 'Sederhanakan rancangan formulir pemesanan, bebaskan registrasi akun, dan buat isian semudah mungkin.',
                                  borderColor: 'border-l-purple-500 bg-purple-50/10'
                                },
                                {
                                  name: 'Download Nota (Simpan Receipt)',
                                  symbol: '💾',
                                  category: 'conv',
                                  categoryLabel: 'Konversi',
                                  desc: 'Kustomer yang berhasil menyimpan/mengunduh berkas gambar PNG nota belanja untuk divalidasi oleh kasir.',
                                  formula: '(Nota Diunduh / Draft Invoice) * 100%',
                                  leakageExplanation: 'Kustomer tidak tahu kegunaan gambar nota atau tombol unduh kurang menonjol di halaman sukses.',
                                  action: 'Pastikan tombol unduh berwarna mencolok dan jelaskan bahwa gambar berkas nota ini dibutuhkan saat pembayaran.',
                                  borderColor: 'border-l-indigo-500 bg-indigo-50/10'
                                },
                                {
                                  name: 'Kirim WhatsApp (Final Order)',
                                  symbol: '💬',
                                  category: 'conv',
                                  categoryLabel: 'Konversi',
                                  desc: 'Langkah pamungkas di mana kustomer mengirimkan rincian invoice belanja ke chat WhatsApp Admin Suki.',
                                  formula: '(Total Sukses WA / Nota Diunduh) * 100%',
                                  leakageExplanation: 'Bocor di sini berarti pelanggan mengira transaksi otomatis instan tanpa perlu memencet tombol kirim pesan WA.',
                                  action: 'Tambahkan pop-up pengingat persuasif agar pembeli langsung mengklik tombol WA guna mengunci kursi order dapur.',
                                  borderColor: 'border-l-green-500 bg-green-50/10'
                                },
                                {
                                  name: 'Drop-Off & Kebocoran (Leakage)',
                                  symbol: '🛑',
                                  category: 'conv',
                                  categoryLabel: 'Konversi',
                                  desc: 'Persentase kegagalan kustomer yang keluar/membatalkan pesanan di tengah gerbang alur utama belanja.',
                                  formula: 'Kebocoran % = 100% - Persentase Tingkat Konversi Langkah Tersebut',
                                  leakageExplanation: 'Semakin tinggi angka drop-off, semakin banyak potensi transaksi dan omzet bulanan yang terbuang sia-sia.',
                                  action: 'Lihat tanda merah "KEBOCORAN TERBESAR" pada visual corong di dashboard Anda untuk tindakan cepat.',
                                  borderColor: 'border-l-red-500 bg-red-50/10'
                                },
                                {
                                  name: 'AOV (Rata-rata Nilai Belanja)',
                                  symbol: '💵',
                                  category: 'finance',
                                  categoryLabel: 'Keuangan',
                                  desc: 'Rata-rata nilai uang belanja rupiah dalam satu kali transaksi nota belanja resmi kustomer.',
                                  formula: 'Total Estimasi Omzet Penjualan / Jumlah Invoice Terbuat',
                                  leakageExplanation: 'Bila nilai AOV-nya terlampau kecil, Anda akan kesulitan mengejar target laba kotor harian restoran.',
                                  action: 'Tawarkan menu pelengkap tambahan (saus spesial, aneka minum, topping instan) di halaman checkout.',
